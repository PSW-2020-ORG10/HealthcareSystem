...
namespace PatientWebAppSeleniumTests.Pages
{
    public class FeedbackPage
    {
        ...
        public const string URI = "http://localhost:60198/admin-feedback";
        ...
        private IWebElement LastRowMessage => driver.FindElement(By.XPath("(//table[1]/tbody/tr)[last()]/td[1]"));
        private IWebElement LastRowDate => driver.FindElement(By.XPath("(//table[1]/tbody/tr)[last()]/td[2]"));
        private IWebElement LastRowIsAnonymous => driver.FindElement(By.XPath("(//table[1]/tbody/tr)[last()]/td[3]"));
