...
export const feedbackPublished = (id) => async (dispatch) => {
    try {
        debugger
        const response = await axios.put("https://gatewayapi-org10.herokuapp.com/api/feedback/" + id, {}, {
                headers: { "Access-Control-Allow-Origin": "*",
                "Authorization": "Bearer " + localStorage.getItem('token')}
              }); 
        dispatch({
...
export const loadedPublishedFeedback = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/feedback/published",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }); 
...
export const loadedAllFeedback = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/feedback",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }); 
...
export const loadedAllPrescriptions = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/prescription",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }); 
...
export const loadedAllPatientPrescriptions = () => async (dispatch) => {
    try {
        ...
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/prescription/patient/" + id,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }); 
...
export const patientRegistered = (patient) => async (dispatch) => {
    try {
        debugger;
        await axios.post("https://gatewayapi-org10.herokuapp.com/api/patientuser", patient,
        {
            headers: { "Access-Control-Allow-Origin": "*" },
          });
        debugger;
...
export const simpleSearchPatientPrescriptions = (prescription) => async (dispatch) => {
    ...
    try {
        ...
        const response = await axios.post("https://gatewayapi-org10.herokuapp.com/api/prescription/search", prescription,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }); 
...
export const findOnePatient = (id) => async (dispatch) => {
    try {
        debugger;
        var id = localStorage.getItem("patientId")
        await axios.get("https://gatewayapi-org10.herokuapp.com/api/patientuser/getOne/" + id,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }) 
        .then(function (response) {
            ...
            axios.get("https://userapi-org10.herokuapp.com/api/patientuser/getimage/" + response.data.file,
            {
                headers: { "Access-Control-Allow-Origin": "*",
                           "Authorization" :  "Bearer " + localStorage.getItem("token")}
              })
...
export const advancedSearchPatientPrescriptions = (prescription) => async (dispatch) => {
    ...
    try {
        prescription.patientId = localStorage.getItem("patientId")
        debugger;
        const response = await axios.post("https://gatewayapi-org10.herokuapp.com/api/prescription/advancedsearch", prescription,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }); 
...
export const loadedAllPatientReports = (patientId) => async (dispatch) => {
    ...
    try {
        axios.all(  [axios.get('https://gatewayapi-org10.herokuapp.com/api/doctorappointment/' + patientId,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }),
...
export const simpleSearchAppointments  = (searchDto) => async (dispatch) => {
    ...
    try {
        axios.all([axios.post('https://gatewayapi-org10.herokuapp.com/api/appointmentSearch/search', searchDto,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          }),
...
export const loadedAppointmentSurvey = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/survey",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const surveyCreated = (survey) => async (dispatch) => {
    ...
    try {
        debugger;
        await axios.post("https://gatewayapi-org10.herokuapp.com/api/survey", survey,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const advancedSearchPatientAppointments = (appointment) => async (dispatch) => {
    try {
        ...
        const response = await axios.post("https://gatewayapi-org10.herokuapp.com/api/appointmentsearch/advancedsearch", appointment,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllPatientAppointments = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/doctorappointment/patient",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllRates = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/survey/getRates",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllDoctorRates = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/survey/getDoctorRates",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllAvailableDoctors = (specialty, date, patientId) => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/doctor/available?specialty=" + specialty+ "&date=" + date + "&patientId=" + patientId,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllPatientAppointmentsInTwoDays = () => async (dispatch) => {
    try {
        debugger;
        var id = localStorage.getItem("patientId")
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/doctorappointment/patientInTwoDays/" + id,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllAvailableAppointments = (dto) => async (dispatch) => {
    try {
        ...
        const response = await axios.post("https://gatewayapi-org10.herokuapp.com/api/doctorappointment/availableappointments", dto,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllPatientAppointmentsInFuture = () => async (dispatch) => {
    try {
        debugger;
        var id = localStorage.getItem("patientId")
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/doctorappointment/patientInFuture/" + id,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const appointmentScheduled = (appointment) => async (dispatch) => {
    try {
        ...
        const response = await axios.post("https://gatewayapi-org10.herokuapp.com/api/doctorappointment", appointment,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const cancelAppointment = (appointmentId) => async (dispatch) => {
    try {
        debugger;
        const response = await axios.put("https://gatewayapi-org10.herokuapp.com/api/doctorappointment/" + appointmentId, {},
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllPatientAppointmentsWithSurvey = () => async (dispatch) => {
    try {
        debugger;
        var id = localStorage.getItem("patientId")
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/survey/" + id,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllPatientAppointmentsWithoutSurvey = () => async (dispatch) => {
    try {
        debugger;
        var id = localStorage.getItem("patientId")
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/survey/getWithSurveys/" + id,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllDoctors = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/doctor",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const recommendAppointment = (appointment) => async (dispatch) => {
    ...
    try {
        debugger;
        appointment.patientId = localStorage.getItem("patientId");
        const response = await axios.post("https://gatewayapi-org10.herokuapp.com/api/doctorappointment/recommend", appointment,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllPatients = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/patientuser",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const blockPatient = (patientId) => async (dispatch) => {
    try {
        debugger;
        const response = await axios.put("https://gatewayapi-org10.herokuapp.com/api/patientuser/" + patientId, {},
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedMaliciousPatients = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/patientuser/malicious",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedImage = (fileName) => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://gatewayapi-org10.herokuapp.com/api/patientuser/getimage/" + fileName,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const loadedAllMessages = () => async (dispatch) => {
    try {
        debugger;
        const response = await axios.get("https://userapi-org10.herokuapp.com/api/message",
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
...
export const userLoggedIn = (user) => async (dispatch) => {
    try {
        debugger;
        const response = await axios.post("https://gatewayapi-org10.herokuapp.com/api/login", user,
        {
            headers: { "Access-Control-Allow-Origin": "*",
                       "Authorization" :  "Bearer " + localStorage.getItem("token")}
          });
