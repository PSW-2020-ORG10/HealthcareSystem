...
export const MIN_STEPS = "minSteps";
export const MIN_STEPS_ERROR = "minStepsError";
export const MAX_STEPS = "maxSteps";
export const MAX_STEPS_ERROR = "maxStepsError";
export const SUCCES_RATIO = "succesRatio";
