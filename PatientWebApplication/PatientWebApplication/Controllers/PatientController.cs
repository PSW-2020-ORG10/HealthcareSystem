...
namespace PatientWebApplication.Controllers
{
    ...
    public class PatientUserController : ControllerBase
    {
        ...
        /// <summary> This method is calling <c>PatientService</c> to check if <c>PatientUser</c> with id <paramref name="id"/> exists. </summary>
        /// <param name="id"><c>id</c> is id of patient that needs to be found. 
        /// <returns> If <paramref name="id"/>and patient is not valid returns 400 Bad Request; if patient is successfully found, returns 200 OK and redirects.</returns>
        ...
        {
            PatientUser patient = PatientService.GetOne(4);
