            ...
            <div>
                ...
                <div className="wrap">
                    <div className="item-row">
                        <div className="check-flag">
                            ...
                            <span className="small-text-label hours">{'Average rate: ' + allRates.doctorAverage.toFixed(2)}</span>
                ...
                <div className="wrap">
                    <div className="item-row">
                        <div className="check-flag">
                            <span className="small-text-label">Average rating of:</span>
                            <span className="small-text-label hours">{'Average rate: ' + allRates.medicalStaffAverage.toFixed(2)}</span>
                ...
                <div className="wrap">
                    <div className="item-row">
                        <div className="check-flag">
                            <span className="small-text-label">Average rating of:</span>
                            <span className="small-text-label hours">{'Average rate: ' + allRates.hospitalAverage.toFixed(2)}</span>
