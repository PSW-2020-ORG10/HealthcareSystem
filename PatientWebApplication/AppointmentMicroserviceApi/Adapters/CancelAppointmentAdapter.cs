...
{
    public class CancelAppointmentAdapter
    {
        ...
        public MicroserviceAppointmentDto AppointmentToAppointmenDto(DoctorAppointment appointment)
        {
        ...
        public List<MicroserviceAppointmentDto> ConvertAppointmentListToAppointmentDtoList(List<DoctorAppointment> appointments)
        {
