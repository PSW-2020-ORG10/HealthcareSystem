    ...
    public class MyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Schedule>().HasData(
                ...
                new Schedule(22, 1, "16/01/2021", true, 3, "1"),
                new Schedule(23, 1, "17/01/2021", true, 3, "Ordination 1"),
                new Schedule(24, 1, "18/01/2021", true, 3, "Ordination 1"),
                new Schedule(25, 1, "19/01/2021", true, 4, "Ordination 1"),
                new Schedule(26, 1, "20/01/2021", true, 3, "Ordination 1"),
                new Schedule(27, 1, "21/01/2021", true, 3, "Ordination 1"),
                new Schedule(28, 1, "22/01/2021", true, 3, "Ordination 1")
           );
