...
namespace PatientWebApplicationTests
{
    public class AppointmentsAdvancedSearchTests
    {
        ...
        public void Find_Appointments()
        {
            ...
            RegularAppointmentService service = new RegularAppointmentService(CreateStubRepository(), new Mock<IEmployeesScheduleRepository>().Object, new DoctorService(CreateStubRepository(), new Mock<IEmployeesScheduleRepository>().Object, new Mock<IDoctorRepository>().Object));
